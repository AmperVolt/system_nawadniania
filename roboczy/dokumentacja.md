...
Do symulacji dołączono pliki `index.html`, `styles.css` i `script.js`. Symulator nie zmienia poziomu wody automatycznie; odzwierciedla zewnętrzne warunki ustawiane suwakami i natychmiast reaguje na zmianę poziomu wody, wilgotności oraz ręczne przestawienie czasu poza koniec podlewania. Symulator pokazuje LCD Keypad Shield 16x2, osobny czerwony STOP D2 dla podlewania i napełniania, przekaźnik podlewania, przekaźnik napełniania A2, jeden suwak poziomu wody, cyfrowe stany PEŁNY/PUSTY, wilgotność gleby oraz okno ustawienia dnia i czasu RTC; czas podlewania ustawia się wyłącznie w ustawieniach sterownika.
